...
class GetEverythingUsecases extends UseCase<List<NewsEntity>, PageNewsParamsUsecases> {
  final NewsRepository newsRepository;

  GetEverythingUsecases(this.newsRepository);
  @override
  Future<Either<Failure, List<NewsEntity>>> call(PageNewsParamsUsecases params) async {
    return newsRepository.getEverything(params.page, params.pageSize);
  }
}
